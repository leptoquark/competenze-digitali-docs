...
|         |         |         |         |         | )       |         |
+=========+=========+=========+=========+=========+=========+=========+
| 2.1.1.4 | ADA.16. | ADA.16. | ADA.16. | ADA.16. | Systems | Analist |
| .1      | 238.778 | 239.785 | 239.783 | 239.786 | Archite | a       |
| -       | -Ideazi | -Proget | -Proget | -Proget | ct      | e       |
| Analist | one     | tazione | tazione | tazione |         | Progett |
| i       | e       | e       | e       | e       |         | ista    |
| e       | definiz | realizz | realizz | realizz |         | di      |
| Progett | ione    | azione  | azione  | azione  |         | Softwar |
| isti    | della   | di      | di      | di      |         | e       |
| di      | specifi | applica | soluzio | soluzio |         |         |
| Softwar | ca      | tivi    | ni      | ni      |         |         |
| e       | soluzio | softwar | di      | softwar |         |         |
|         | ne      | e       | Data    | e       |         |         |
|         | ICT     | multi-t | managem | con     |         |         |
|         |         | ier     | ent     | linguag |         |         |
|         |         |         |         | gi      |         |         |
|         |         |         |         | di      |         |         |
|         |         |         |         | scripti |         |         |
...
|         |         |         |         | ecc.)   |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| 2.1.1.4 | ADA.16. | ADA.16. | ADA.16. |         | System  | Analist |
| .2      | 239.785 | 238.778 | 239.786 |         | Analyst | a       |
| -       | -Proget | -Ideazi | -Proget |         |         | di      |
| Analist | tazione | one     | tazione |         |         | Sistema |
| i       | e       | e       | e       |         |         |         |
| di      | realizz | definiz | realizz |         |         |         |
| Sistema | azione  | ione    | azione  |         |         |         |
|         | di      | della   | di      |         |         |         |
|         | applica | specifi | soluzio |         |         |         |
|         | tivi    | ca      | ni      |         |         |         |
|         | softwar | soluzio | softwar |         |         |         |
|         | e       | ne      | e       |         |         |         |
|         | multi-t | ICT     | con     |         |         |         |
|         | ier     |         | linguag |         |         |         |
|         |         |         | gi      |         |         |         |
...
|         |         |         | ecc.)   |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| 2.1.1.4 |  ADA.16 |  ADA.16 | ADA.16. |         | Vedi    | Analist |
| .3      | .239.78 | .239.78 | 238.778 |         | nota [3 | a       |
| -       | 7-Proge | 6-Proge | -Ideazi |         | ]_      | e       |
| Analist | ttazion | ttazion | one     |         |         | Progett |
| i       | e       | e       | e       |         |         | ista    |
| e       | e       | e       | definiz |         |         | di      |
| Progett | realizz | realizz | ione    |         |         | Applica |
| isti    | azione  | azione  | della   |         |         | zioni   |
| di      | dell'in | di      | specifi |         |         | Web     |
| Applica | terfacc | soluzio | ca      |         |         |         |
| zioni   | ia      | ni      | soluzio |         |         |         |
| Web     | utente  | softwar | ne      |         |         |         |
|         |         | e       | ICT     |         |         |         |
|         |         | con     |         |         |         |         |
|         |         | linguag |         |         |         |         |
|         |         | gi      |         |         |         |         |
...
|         |         | ecc.)   |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| 2.1.1.5 | ADA.16. | ADA.16. |         |         | Network | Special |
| .1      | 239.781 | 238.778 |         |         | Special | ista    |
| -       | -Proget | -Ideazi |         |         | ist     | in Reti |
| Special | tazione | one     |         |         |         | e       |
| isti    | e       | e       |         |         |         | Comunic |
| in Reti | impleme | definiz |         |         |         | azioni  |
| e       | ntazion | ione    |         |         |         | Informa |
| Comunic | e       | della   |         |         |         | tiche   |
| azioni  | dell'in | specifi |         |         |         |         |
| Informa | frastru | ca      |         |         |         |         |
| tiche   | ttura   | soluzio |         |         |         |         |
|         | ICT     | ne      |         |         |         |         |
|         |         | ICT     |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| 2.1.1.5 |  ADA.16 |  ADA.16 |         |         | Vedi    | Analist |
| .2      | .239.78 | .238.77 |         |         | nota [4 | a       |
| -       | 3-Proge | 8-Ideaz |         |         | ]_      | e       |
| Analist | ttazion | ione    |         |         |         | Progett |
| i       | e       | e       |         |         |         | ista    |
| e       | e       | definiz |         |         |         | di Basi |
| Progett | realizz | ione    |         |         |         | Dati    |
| isti    | azione  | della   |         |         |         |         |
| di Basi | di      | specifi |         |         |         |         |
| Dati    | soluzio | ca      |         |         |         |         |
|         | ni      | soluzio |         |         |         |         |
...
.. [1]
   Nel rispetto del principio di mutua esclusività della CP2011, non è
   possibile collocare lo stesso esempio di professione in due Unità
   Professionali distinte. Avendo scelto di assegnare ai Digital Media
   Specialist la corrispondenza con i Tecnici Web, non è possibile
   assegnare agli Analisti e Progettisti di Applicazioni Web una
   corrispondenza con un profilo UNI di seconda generazione. Tuttavia,
   si ritiene utile mantenere l’Unità Professionale 2.1.1.4.3 (Analisti
   e Progettisti di Applicazioni Web) in previsione di successive
   evoluzioni.

.. [2]
   Nel rispetto del principio di mutua esclusività della CP2011, non è
   possibile collocare lo stesso esempio di professione in due Unità
   Professionali distinte. Avendo scelto di assegnare ai Database
   Administrator la corrispondenza con i Tecnici Gestori di Basi di
   Dati, non è possibile assegnare agli Analisti e Progettisti di Basi
   Dati una corrispondenza con un profilo UNI di seconda generazione.
